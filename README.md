...
#### 12.12 ---> 继续尝试减小rank参数，这里展示更精确的结果；绘图，进行各模型的时间代价的直观对比
| Model                             | Avg RMSE    | Avg Time (s) | Fold 1 RMSE | Fold 2 RMSE | Fold 3 RMSE | Fold 4 RMSE | Fold 5 RMSE |
| --------------------------------- | ----------- | ------------ | ----------- | ----------- | ----------- | ----------- | ----------- |
| SoftImpute(svds_lambda=80_r=50)   | 0.943756546 | 196.7933422  | 0.9454044   | 0.944341961 | 0.942372697 | 0.944653863 | 0.942009805 |
| SoftImpute(svds_lambda=100_r=100) | 0.943756754 | 273.3846097  | 0.945404448 | 0.94434203  | 0.942373451 | 0.944654032 | 0.942009807 |
| ALS(rank=50)                      | 0.943755786 | 86.94834213  | 0.945404626 | 0.944343158 | 0.942367594 | 0.944653395 | 0.942010158 |
| ALS(rank=100)                     | 0.94375679  | 198.4282144  | 0.94540461  | 0.944342497 | 0.942372157 | 0.944654086 | 0.942010601 |
